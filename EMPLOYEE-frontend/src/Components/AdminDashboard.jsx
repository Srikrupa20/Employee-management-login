          ...
          <div className="d-flex bg-dark col-2 col-md-3 col-xl-2 px-sm-2 px-0 flex-column  px-3 pt-2 text-white min-vh-100 tw-fixed sm:tw-h-full">
            ...
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
              ...
              <li className={`w-100 hover:tw-bg-gray-300 mb-1 tw-rounded ${activeLink === "/admindashboard/adminlist" ? "tw-bg-gray-300" : ""}`}>
                ...
                >
                 <i className="bi bi-person-check ms-3"></i>
              ...
              <li className={`w-100 hover:tw-bg-gray-300 mb-1 tw-rounded ${activeLink === "/admindashboard/EmployeeLeave" ? "tw-bg-gray-300" : ""}`}>
                <Link
                  to="/admindashboard/EmployeeLeave"
                  className={`nav-link ${activeLink === "/admindashboard/EmployeeLeave" ? "tw-text-black" : "text-white"} px-0 align-middle tw-text-xs md:tw-text-xl flex items-center justify-center hover:tw-text-black`}
                  onClick={() => handleNavClick('/admindashboard/EmployeeLeave')}
                >
                  <i className="bi bi-person ms-3"></i>
                  <span className="ms-2 d-none d-sm-inline">Employee Leave</span>
                </Link>
              </li>
