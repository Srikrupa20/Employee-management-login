				...
				<div key={index} className="col-sm-6 col-lg-4 mb-5">
					<div
						...
						style={{
							...
							position: "relative",
							background:
								"linear-gradient(to bottom right, #89CFF0,#007FFF)",
						}}
					>
						<div className="card-body">
							<div className="tw-font-bold tw-text-xl tw-mb-2 tw-text-gray-600">
								{meeting.title}
							</div>
							<p className="">
								Date: {meeting.date}
						...
						<button
							...
							onClick={() =>
								handleJoinMeeting(meeting.meeting_code)
							}
						>
							Join Meeting
						</button>
			...
			<div className="col-sm-6 col-lg-4 mb-5">
				...
				>
					<div className="card-body" style={{ overflow: "hidden" }}>
						...
						<p>
							HR portal for employee management, performance
							reviews and recruitment tools.
							<a
